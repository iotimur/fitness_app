...
class matplotlibWidgetUper(QWidget):
    def __init__(self, parent = None):
        super(matplotlibWidgetUper, self).__init__(parent)
        self.figure = Figure()
...
class matplotlibWidgetDown(QWidget):
    def __init__(self, parent = None):
        super(matplotlibWidgetDown, self).__init__(parent)
        self.figure = Figure()
        self.canvas = FigureCanvas(self.figure)
        self.axis = self.figure.add_subplot(111)
